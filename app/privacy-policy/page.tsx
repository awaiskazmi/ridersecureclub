const PrivacyPolicy = () => {
  return (
    <div>
      <h1 className="text-4xl font-bold tracking-tight mb-7">Privacy Policy</h1>
      <div className="flex flex-col gap-3">
        <p>
          Rider Secure Club built the Rider Secure Club app as free app. This
          SERVICE is provided by Rider Secure Club at no cost and is intended
          for use as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Rider Secure Club unless
        ...
        <p>This policy is effective as of 10-11-2025.</p>
        <h4 className="mt-3">
          <strong>Refund Policy</strong>
        </h4>
        <p>
          In case of refund or dispute please email us and we will process your
        ...
        <p>
          ...
          <a href="mailto:ridesecure50@gmail.com" className="underline">
